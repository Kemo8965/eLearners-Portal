...
<head>
  ...
  <title>eLearners Platform| Home</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/auth/images/favicon.ico" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1> <img src="assets/auth/images/logo-sm.png" alt="logo-light" height="20"> <a href="#">eLearners Platform</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="/login" class="download-btn"><i class="bx bxl-play-store"></i> Sign in</a></li>
          <li><a href="/register" class="download-btn"><i class="bx bxl-apple"></i>Register</a>
          </div></li>
        </ul>
      ...
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            ...
            <a href="/login" class="download-btn"><i class='bx bxs-right-arrow-circle'></i></i> Sign in</a>
            <a href="/register" class="download-btn"><i class='bx bxs-user-account'></i>Register</a>
          </div>
        </div>
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="assets/auth/img/hero-img.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
